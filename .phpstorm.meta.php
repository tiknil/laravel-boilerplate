    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'bs-blade-forms' => \Tiknil\BsBladeForms\BsBladeForms::class,
            'bugsnag' => \Bugsnag\Client::class,
            'bugsnag.logger' => \Bugsnag\PsrLogger\BugsnagLogger::class,
            'bugsnag.multi' => \Bugsnag\PsrLogger\MultiLogger::class,
    ...
    override(\config(), map([
            ...
            'livewire.component_namespaces.auth' => 'string',
            'livewire.component_namespaces.backend' => 'string',
            'livewire.component_namespaces.frontend' => 'string',
            ...
            'livewire.temporary_file_upload.chunk.enabled' => 'boolean',
            'livewire.temporary_file_upload.chunk.size' => 'integer',
            'livewire.temporary_file_upload.chunk.retry_delays' => 'array',
            'livewire.temporary_file_upload.chunk.max_upload_time' => 'integer',
            'livewire.temporary_file_upload.chunk.middleware' => 'NULL',
            'livewire.temporary_file_upload.chunk.absolute_max_bytes' => 'integer',
...
'database.connections.sqlsrv.password','database.connections.sqlsrv.charset','database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.testing.driver',
'database.connections.testing.host','database.connections.testing.port','database.connections.testing.database','database.connections.testing.username','database.connections.testing.password',
'database.connections.testing.charset','database.connections.testing.collation','database.connections.testing.prefix','database.connections.testing.strict','database.connections.testing.engine',
'database.connections.testing.options','database.migrations.table','database.migrations.update_date_on_publish','database.redis.client','database.redis.options.cluster',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/public/storage',
...
'fortify.features','livewire.component_locations','livewire.component_namespaces.auth','livewire.component_namespaces.backend','livewire.component_namespaces.frontend',
...
'livewire.temporary_file_upload.max_upload_time','livewire.temporary_file_upload.cleanup','livewire.temporary_file_upload.chunk.enabled','livewire.temporary_file_upload.chunk.size','livewire.temporary_file_upload.chunk.retry_delays',
'livewire.temporary_file_upload.chunk.max_upload_time','livewire.temporary_file_upload.chunk.middleware','livewire.temporary_file_upload.chunk.absolute_max_bytes','livewire.render_on_redirect','livewire.legacy_model_binding',
...
'two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','sanctum.csrf-cookie','default-livewire.update','livewire.upload-file','livewire.preview-file','ignition.healthCheck','ignition.executeSolution',
'ignition.updateConfig','auth.logout','frontend.home',
'backend.profile','backend.profile.submit','backend.users','backend.users.create','backend.users.store',
'backend.users.edit','backend.users.update','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'5f1b5868a608e1d309c9b45621c708c9::home','5f1b5868a608e1d309c9b45621c708c9::layouts.footer','5f1b5868a608e1d309c9b45621c708c9::layouts.header','5f1b5868a608e1d309c9b45621c708c9::layouts.page','694fe29dc53bf841710a884e9bc40c10::forgot-password',
'694fe29dc53bf841710a884e9bc40c10::login','694fe29dc53bf841710a884e9bc40c10::page','694fe29dc53bf841710a884e9bc40c10::reset-password','auth.forgot-password','auth.login',
'auth.page','auth.reset-password','auth::forgot-password','auth::login','auth::page',
'auth::reset-password','backend.components.modal','backend.layouts.alerts','backend.layouts.header','backend.layouts.page',
'backend.layouts.sidebar','backend.profile','backend.users.create','backend.users.edit','backend.users.fields',
'backend.users.table','backend.users.table-row','backend::components.modal','backend::layouts.alerts','backend::layouts.header',
'backend::layouts.page','backend::layouts.sidebar','backend::profile','backend::users.create','backend::users.edit',
'backend::users.fields','backend::users.table','backend::users.table-row','f874c2050928ae0cadaa77a81053fb45::components.modal','f874c2050928ae0cadaa77a81053fb45::layouts.alerts',
'f874c2050928ae0cadaa77a81053fb45::layouts.header','f874c2050928ae0cadaa77a81053fb45::layouts.page','f874c2050928ae0cadaa77a81053fb45::layouts.sidebar','f874c2050928ae0cadaa77a81053fb45::profile','f874c2050928ae0cadaa77a81053fb45::users.create',
'f874c2050928ae0cadaa77a81053fb45::users.edit','f874c2050928ae0cadaa77a81053fb45::users.fields','f874c2050928ae0cadaa77a81053fb45::users.table','f874c2050928ae0cadaa77a81053fb45::users.table-row','frontend.home',
'frontend.layouts.footer','frontend.layouts.header','frontend.layouts.page','frontend::home','frontend::layouts.footer',
'frontend::layouts.header','frontend::layouts.page','notifications::email','vendor.mail.html.button','vendor.mail.html.footer',
...
'bs-blade-forms::autocomplete','bs-blade-forms::checkbox','bs-blade-forms::form','bs-blade-forms::icon-group','bs-blade-forms::input',
'bs-blade-forms::label','bs-blade-forms::multi-select','bs-blade-forms::radio','bs-blade-forms::search-select','bs-blade-forms::select',
'bs-blade-forms::textarea','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
...
'pagination::tailwind','wire-table::bs4.bulk-select','wire-table::bs4.empty-row','wire-table::bs4.header','wire-table::bs4.loading',
'wire-table::bs4.pagination','wire-table::bs4.simple-pagination','wire-table::bs4.style','wire-table::bs4.table','wire-table::bs5.bulk-select',
'wire-table::bs5.empty-row','wire-table::bs5.header','wire-table::bs5.loading','wire-table::bs5.pagination','wire-table::bs5.simple-pagination',
'wire-table::bs5.style','wire-table::bs5.table','wire-table::layout','wire-table::row',);
...
'validation.custom.attribute-name.rule-name','backend.save','backend.search','backend.created_at','backend.create',
'backend.edit','backend.delete','backend.delete_confirm_request','backend.logout','backend.logout_confirm',
'backend.users','backend.profile','backend.profile_update_link','backend.submit_success','backend.password_update_hint',
'backend.create_user','backend.edit_user','backend.all_roles','emails.action_subcopy','login.login_page.title',
'login.login_page.subtext','login.login_page.remember_me','login.login_page.submit_btn','login.login_page.password_forgot_link','login.forgot_psw_page.title',
'login.forgot_psw_page.subtext','login.forgot_psw_page.submit_btn','login.forgot_psw_page.login_link','login.forgot_psw_page.success_message','login.forgot_psw_page.error_message',
'login.reset_page.title','login.reset_page.subtext','login.reset_page.submit_btn','login.reset_email.subject','login.reset_email.main_text',
'login.reset_email.reset_btn','login.reset_email.expiration_notice','login.reset_email.final_text','user.name','user.role',
'user.email','user.password','user.password_confirmation','user.roles.Admin','user.roles.User',
'validation.password','bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.en.components.custom-select.search-placeholder','bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.en.components.custom-select.no-results','bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.en.components.custom-select.select-all','bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.en.components.custom-select.unselect-all',
'bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.it.components.custom-select.search-placeholder','bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.it.components.custom-select.no-results','bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.it.components.custom-select.select-all','bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.it.components.custom-select.unselect-all','wire-table::.var.www.vendor.tiknil.wire-table.lang.en.table.loading',
'wire-table::.var.www.vendor.tiknil.wire-table.lang.en.table.empty','wire-table::.var.www.vendor.tiknil.wire-table.lang.en.table.filtered_empty','wire-table::.var.www.vendor.tiknil.wire-table.lang.en.table.sort_label','wire-table::.var.www.vendor.tiknil.wire-table.lang.en.table.result_count','wire-table::.var.www.vendor.tiknil.wire-table.lang.en.table.simple_page_number',
'wire-table::.var.www.vendor.tiknil.wire-table.lang.it.table.loading','wire-table::.var.www.vendor.tiknil.wire-table.lang.it.table.empty','wire-table::.var.www.vendor.tiknil.wire-table.lang.it.table.filtered_empty','wire-table::.var.www.vendor.tiknil.wire-table.lang.it.table.sort_label','wire-table::.var.www.vendor.tiknil.wire-table.lang.it.table.result_count',
'wire-table::.var.www.vendor.tiknil.wire-table.lang.it.table.simple_page_number',);
...
'DB_USERNAME','DB_PASSWORD','BROADCAST_CONNECTION','CACHE_STORE','FILESYSTEM_DISK',
...
'TELESCOPE_ENABLED','BUGSNAG_API_KEY',);
