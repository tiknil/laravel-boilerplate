...
'backup.cleanup.default_strategy.keep_yearly_backups_for_years','backup.cleanup.default_strategy.delete_oldest_backups_when_using_more_megabytes_than','bugsnag.api_key','bugsnag.app_type','bugsnag.app_version',
'bugsnag.batch_sending','bugsnag.endpoint','bugsnag.filters','bugsnag.hostname','bugsnag.proxy',
'bugsnag.project_root','bugsnag.project_root_regex','bugsnag.strip_path','bugsnag.strip_path_regex','bugsnag.query',
'bugsnag.bindings','bugsnag.octane_breadcrumbs','bugsnag.release_stage','bugsnag.notify_release_stages','bugsnag.send_code',
'bugsnag.callbacks','bugsnag.user','bugsnag.logger_notify_level','bugsnag.auto_capture_sessions','bugsnag.session_endpoint',
'bugsnag.build_endpoint','bugsnag.discard_classes','bugsnag.redacted_keys','bugsnag.feature_flags','bugsnag.max_breadcrumbs',
'bugsnag.attach_hidden_context','fortify.guard','fortify.middleware','fortify.auth_middleware','fortify.passwords',
...
'mail.markdown.paths','sanctum.stateful','sanctum.guard','sanctum.expiration','sanctum.token_prefix',
...
'services.mailgun.domain','services.mailgun.secret','services.mailgun.endpoint','services.mailgun.scheme','telescope.enabled',
...
'auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','app.name','app.env',
...
'app.aliases.Uri','app.aliases.Validator','app.aliases.View','app.aliases.Vite','database.default',
...
'database.redis.cache.username','database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','cache.default',
...
'cache.stores.dynamodb.endpoint','cache.stores.octane.driver','cache.prefix','session.driver','session.lifetime',
...
'queue.failed.driver','queue.failed.database','queue.failed.table','broadcasting.default','broadcasting.connections.reverb.driver',
...
'filesystems.links./var/www/public/storage','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'two-factor.secret-key','two-factor.recovery-codes','sanctum.csrf-cookie','telescope','livewire.update','livewire.upload-file','livewire.preview-file','ignition.healthCheck','ignition.executeSolution',
'ignition.updateConfig','auth.logout',
'backend.profile','backend.profile.submit','backend.users','backend.users.create','backend.users.store',
'backend.users.edit','backend.users.update','storage.local',);
        registerArgumentsSet('views', 
'auth.forgot-password','auth.login','auth.page','auth.reset-password','backend.components.alerts',
'backend.components.header','backend.components.sidebar','backend.page','backend.profile','backend.users.actions',
'backend.users.create','backend.users.edit','backend.users.fields','backend.users.table','backend.users.table-page',
'notifications::email','utils.livewire-setup','vendor.mail.html.button','vendor.mail.html.footer','vendor.mail.html.header',
...
'vendor.mail.text.panel','vendor.mail.text.subcopy','vendor.mail.text.table','vendor.notifications.email','bs-blade-forms::checkbox',
'bs-blade-forms::form','bs-blade-forms::icon-group','bs-blade-forms::input','bs-blade-forms::label','bs-blade-forms::multi-select',
'bs-blade-forms::radio','bs-blade-forms::search-select','bs-blade-forms::select','bs-blade-forms::textarea','laravel-exceptions::401',
...
'pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','telescope::layout','wire-table::bs4.bulk-select',
'wire-table::bs4.empty-row','wire-table::bs4.header','wire-table::bs4.loading','wire-table::bs4.pagination','wire-table::bs4.simple-pagination',
'wire-table::bs4.style','wire-table::bs4.table','wire-table::bs5.bulk-select','wire-table::bs5.empty-row','wire-table::bs5.header',
'wire-table::bs5.loading','wire-table::bs5.pagination','wire-table::bs5.simple-pagination','wire-table::bs5.style','wire-table::bs5.table',
'wire-table::layout','wire-table::row',);
...
'validation.uuid','validation.custom.attribute-name.rule-name','backend.save','backend.search','backend.created_at',
'backend.create','backend.edit','backend.delete','backend.delete_confirm_request','backend.logout',
'backend.logout_confirm','backend.users','backend.profile','backend.profile_update_link','backend.submit_success',
'backend.password_update_hint','backend.create_user','backend.edit_user','backend.all_roles','components.search-select.search-placeholder',
'components.search-select.no-results','user.name','user.role','user.email','user.password',
'user.password_confirmation','user.roles.Admin','user.roles.User','validation.password','bs-blade-forms::components.search-select.search-placeholder',
'bs-blade-forms::components.search-select.no-results','bs-blade-forms::components.search-select.select-all','bs-blade-forms::components.search-select.unselect-all','wire-table::table.loading','wire-table::table.empty',
'wire-table::table.filtered_empty','wire-table::table.sort_label','wire-table::table.result_count','wire-table::table.simple_page_number',);
