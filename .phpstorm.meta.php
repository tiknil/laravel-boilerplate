...
'bugsnag.redacted_keys','bugsnag.feature_flags','bugsnag.max_breadcrumbs','bugsnag.attach_hidden_context','fortify.guard',
...
'auth.password_timeout','app.name','app.env','app.debug','app.url',
...
'app.aliases.View','app.aliases.Vite','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'database.redis.cache.port','database.redis.cache.database','cache.default','cache.stores.array.driver','cache.stores.array.serialize',
...
'cache.prefix','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'queue.failed.table','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key','broadcasting.connections.reverb.secret',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/public/storage','flare.key',
...
'two-factor.secret-key','two-factor.recovery-codes','sanctum.csrf-cookie','livewire.update','livewire.upload-file','livewire.preview-file','ignition.healthCheck',
...
'bs-blade-forms::select','bs-blade-forms::textarea','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','backend.save',
'backend.search','backend.created_at','backend.create','backend.edit','backend.delete',
'backend.delete_confirm_request','backend.logout','backend.logout_confirm','backend.users','backend.profile',
'backend.profile_update_link','backend.submit_success','backend.password_update_hint','backend.create_user','backend.edit_user',
'backend.all_roles','components.search-select.search-placeholder','components.search-select.no-results','user.name','user.role',
'user.email','user.password','user.password_confirmation','user.roles.Admin','user.roles.User',
'validation.password','bs-blade-forms::components.search-select.search-placeholder','bs-blade-forms::components.search-select.no-results','bs-blade-forms::components.search-select.select-all','bs-blade-forms::components.search-select.unselect-all',
'wire-table::table.loading','wire-table::table.empty','wire-table::table.filtered_empty','wire-table::table.sort_label','wire-table::table.result_count',
'wire-table::table.simple_page_number',);
