...
'hashing.argon.threads','hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','auth.defaults.guard',
...
'auth.passwords.users.throttle','auth.password_timeout','app.name','app.env','app.debug',
...
'app.aliases.URL','app.aliases.Validator','app.aliases.View','app.aliases.Vite','database.default',
'database.connections.sqlite.driver','database.connections.sqlite.url','database.connections.sqlite.database','database.connections.sqlite.prefix','database.connections.sqlite.prefix_indexes',
...
'database.connections.sqlite.pragmas','database.connections.mysql.driver','database.connections.mysql.url','database.connections.mysql.host','database.connections.mysql.port',
...
'database.redis.cache.max_retries','database.redis.cache.backoff_algorithm','database.redis.cache.backoff_base','database.redis.cache.backoff_cap','cache.default',
...
'cache.stores.failover.stores','cache.prefix','session.driver','session.lifetime','session.expire_on_close',
...
'session.http_only','session.same_site','session.partitioned','concurrency.default','queue.default',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/public/storage','bugsnag.api_key','bugsnag.app_type',
'bugsnag.app_version','bugsnag.batch_sending','bugsnag.endpoint','bugsnag.filters','bugsnag.hostname',
'bugsnag.proxy','bugsnag.project_root','bugsnag.project_root_regex','bugsnag.strip_path','bugsnag.strip_path_regex',
'bugsnag.query','bugsnag.bindings','bugsnag.octane_breadcrumbs','bugsnag.release_stage','bugsnag.notify_release_stages',
'bugsnag.send_code','bugsnag.callbacks','bugsnag.user','bugsnag.logger_notify_level','bugsnag.auto_capture_sessions',
'bugsnag.session_endpoint','bugsnag.build_endpoint','bugsnag.discard_classes','bugsnag.redacted_keys','bugsnag.feature_flags',
'bugsnag.max_breadcrumbs','bugsnag.attach_hidden_context','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'fortify.redirects.email-verification','fortify.redirects.password-reset','fortify.features','livewire.class_namespace','livewire.view_path',
...
'livewire.smart_wire_keys','livewire.pagination_theme','livewire.release_token','logging.default','logging.deprecations.channel',
...
'logging.channels.null.handler','logging.channels.emergency.path','logging.channels.bugsnag.driver','logging.channels.deprecations.driver','logging.channels.deprecations.handler',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','sanctum.stateful',
...
'services.mailgun.endpoint','services.mailgun.scheme','telescope.enabled','telescope.domain','telescope.path',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_http_methods','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_status_codes','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','flare.key',
...
'two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','sanctum.csrf-cookie','default.livewire.update','livewire.upload-file','livewire.preview-file','ignition.healthCheck',
'ignition.executeSolution','ignition.updateConfig','auth.logout','frontend.home','backend.profile','backend.profile.submit','backend.users','backend.users.create',
'backend.users.store','backend.users.edit','backend.users.update','storage.local',);
        registerArgumentsSet('views', 
'auth.forgot-password','auth.login','auth.page','auth.reset-password','backend.components.modal',
'backend.layouts.alerts','backend.layouts.header','backend.layouts.page','backend.layouts.sidebar','backend.profile',
'backend.users.actions','backend.users.create','backend.users.edit','backend.users.fields','backend.users.table',
'frontend.home','frontend.layouts.footer','frontend.layouts.header','frontend.layouts.page','notifications::email',
...
'vendor.mail.text.table','vendor.notifications.email','bs-blade-forms::checkbox','bs-blade-forms::form','bs-blade-forms::icon-group',
'bs-blade-forms::input','bs-blade-forms::label','bs-blade-forms::multi-select','bs-blade-forms::radio','bs-blade-forms::search-select',
'bs-blade-forms::select','bs-blade-forms::textarea','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'backend.create_user','backend.edit_user','backend.all_roles','components.search-select.search-placeholder','components.search-select.no-results',
'user.name','user.role','user.email','user.password','user.password_confirmation',
'user.roles.Admin','user.roles.User','validation.password','bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.en.components.search-select.search-placeholder','bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.en.components.search-select.no-results',
'bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.en.components.search-select.select-all','bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.en.components.search-select.unselect-all','bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.it.components.custom-select.search-placeholder','bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.it.components.custom-select.no-results','bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.it.components.custom-select.select-all',
'bs-blade-forms::.var.www.vendor.tiknil.bs-blade-forms.lang.it.components.custom-select.unselect-all','wire-table::.var.www.vendor.tiknil.wire-table.lang.en.table.loading','wire-table::.var.www.vendor.tiknil.wire-table.lang.en.table.empty','wire-table::.var.www.vendor.tiknil.wire-table.lang.en.table.filtered_empty','wire-table::.var.www.vendor.tiknil.wire-table.lang.en.table.sort_label',
'wire-table::.var.www.vendor.tiknil.wire-table.lang.en.table.result_count','wire-table::.var.www.vendor.tiknil.wire-table.lang.en.table.simple_page_number','wire-table::.var.www.vendor.tiknil.wire-table.lang.it.table.loading','wire-table::.var.www.vendor.tiknil.wire-table.lang.it.table.empty','wire-table::.var.www.vendor.tiknil.wire-table.lang.it.table.filtered_empty',
'wire-table::.var.www.vendor.tiknil.wire-table.lang.it.table.sort_label','wire-table::.var.www.vendor.tiknil.wire-table.lang.it.table.result_count','wire-table::.var.www.vendor.tiknil.wire-table.lang.it.table.simple_page_number',);
